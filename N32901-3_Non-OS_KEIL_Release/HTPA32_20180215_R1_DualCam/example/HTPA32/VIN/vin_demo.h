...
/* You need to specify the cropping width base on sensor resolution */
#if 1
#define OPT_CROP_WIDTH		640
#define OPT_CROP_HEIGHT		480
#else
#define OPT_CROP_WIDTH		320
#define OPT_CROP_HEIGHT		240
#endif

/* You need to specify the encode dimension (planar pipe), the value should equal or less cropping window */
#define OPT_ENCODE_WIDTH		32
#define OPT_ENCODE_HEIGHT		32
